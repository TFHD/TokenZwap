export const AMM_ABI = [
	...
	'function addLiquidity(uint256 amountA, uint256 amountB, uint256 deadline) returns (uint256)',
	'function removeLiquidity(uint256 lpAmount, uint256 deadline) returns (uint256, uint256)',
	'function swap(address tokenIn, uint256 amountIn, uint256 minAmountOut, uint256 deadline) returns (uint256)',
